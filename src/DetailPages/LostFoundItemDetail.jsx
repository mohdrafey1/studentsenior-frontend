        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg space-y-6 max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-2">
              <strong className="text-sky-700 text-lg">Status:</strong>
              <span
                className={`px-3 py-1 rounded-full text-sm font-semibold ${
                  lostFoundItem.currentStatus === 'pending'
                    ? 'bg-yellow-100 text-yellow-800'
                    : lostFoundItem.currentStatus === 'claimed'
            ...
            {/* Location */}
            <div>
              <strong className="text-sky-700 text-lg">Location:</strong>
              <p className="text-gray-700 mt-1">{lostFoundItem.location}</p>
            </div>

            {/* Description */}
            <div>
              <strong className="text-sky-700 text-lg">Description:</strong>
              <p className="text-gray-700 mt-1">{lostFoundItem.description}</p>
            </div>

            {/* Type */}
            <div>
              <strong className="text-sky-700 text-lg">Type:</strong>
              <p
                className={`mt-1 text-sm font-semibold ${
                  lostFoundItem.isLost ? 'text-red-500' : 'text-green-500'
                }`}
              >
      ...
      {isEditing && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-white p-8 rounded-2xl shadow-lg w-11/12 max-w-md">
            <h2 className="text-2xl font-bold text-sky-800 mb-6">Edit Item</h2>
