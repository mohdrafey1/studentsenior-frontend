    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-4">
      <div className="bg-white shadow-lg rounded-2xl p-6 w-full max-w-md">
        ...
        <p className="text-gray-600 mb-6 text-center">
          We strive to provide free resources to students by hosting PDFs on
          AWS. This involves ongoing costs. Your donation helps us sustain and
          grow this platform.
        </p>
        ...
        {qrCodeUrl && (
          <div className="text-center mt-6">
            <p className="text-gray-600 mb-2">Scan this QR code to donate:</p>
            <img
              src={qrCodeUrl}
              alt="UPI QR Code"
        ...
        <div className="text-center mt-4">
          ...
          <div className="flex items-center justify-between bg-gray-200 p-2 rounded text-sm w-full">
            <span className="font-mono break-all">7233990060@pthdfc</span>
            <button
              onClick={handleCopy}
