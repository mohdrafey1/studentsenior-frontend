  ...
  const faqs = [
    {
      ...
      answer:
        'Student Senior is a website which connects college students for mentorship, guidance, and community building. Students can askquestions, share knowledge, and trade items in a dedicated store. Senior students can register to mentor juniors,creating a dynamic ecosystem of knowledge sharing. The                   platform also offers a repository of academic resources,including notes and past exam papers, tailored to eachcolleges needs. Our goal is to foster interaction, support,and academic success among students, promotingsustainability and resourcefulness within the collegecommunity. By joining, students can tap into valuable insights, advice, and resources to enhance their college experience...',
    },
    {
      question: 'How do I register?',
      answer:
        "Click on the 'Sign Up' button on the homepage and fill out the registration form with your details.",
    },
    {
      question: 'Can anyone add a college?',
      answer:
        'Only registered users can add colleges to ensure authenticity and maintain data quality.',
    },
    {
    ...
    },
    {
      ...
      answer:
        "You can reach us through the 'Contact Us' page or email us at  studentsenior.help@gmail.com.",
    },
  ];
