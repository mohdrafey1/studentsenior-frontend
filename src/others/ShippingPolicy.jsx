  ...
  return (
    <div className="w-full mx-auto p-6 bg-gradient-to-t from-sky-200 to bg-white">
      <div className="container mx-auto px-4 py-10 max-w-6xl">
        <h1 className="text-3xl font-bold text-center border-b pb-3 mb-5">
          Shipping Policy
        </h1>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc pl-5">
            ...
            <li>
              <strong>Express Delivery:</strong> 2-4 business days
            </li>
            <li>
        ...
        <section className="mb-6">
          ...
          <p>
            ...
            location, and selected shipping method. Free shipping may be
            available on select products or promotions.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p>
            Once shipped, you will receive a tracking number via email to
        ...
        <section className="mb-6">
          ...
          <p>
            Currently, we <strong>only ship within India</strong>. Some remote
            areas may experience longer delivery times.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p>
            If there are unexpected delays, we will notify you via email.
            Student Senior is not responsible for courier delays.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p>
            ...
            <strong>48 hours</strong> with images of the product and packaging.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p>
            Orders once shipped <strong>cannot be canceled</strong>. Refunds are
            only applicable in cases of non-delivery or damaged items.
          </p>
        </section>

        <section className="mb-6">
          <h2 className="text-xl font-semibold">
            9. Payment & Dispute Resolution
          </h2>
          <p>
            All payments are processed securely. If you face payment-related
        ...
        <section>
          ...
          <p>
            ...
            <strong>studentsenior.help@gmail.com</strong> or call{' '}
            <strong>+91 9455346151</strong>
          </p>
        </section>
      </div>
    </div>
