        ...
        <div className="bg-gradient-to-t from-sky-200 to bg-white">
            ...
            <div className="container mx-auto px-4 py-10 max-w-6xl">
                ...
                <p className="mb-4">
                    ...
                    satisfying experience with our services. This refund policy
                    outlines the terms and conditions for refunds and
                    cancellations of any purchases or transactions made through
                    our website.
                </p>
                ...
                <p className="mb-4">
                    If you wish to cancel any services or subscriptions, please
                    contact us as soon as possible. Cancellations are subject to
                    our refund policy and may not be applicable after certain
                    conditions are met (such as content being accessed or
                    downloaded).
                </p>
