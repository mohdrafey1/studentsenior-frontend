        ...
        if (product.telegram) {
            ...
            socialLinks.push(
                <a
                    href={
                        isAvailable
                            ? `https://t.me/+91${product.telegram}`
                            : '#'
                    }
    ...
    const renderProductCard = (product) => {
        ...
        return (
            <div className='h-full'>
                <div
                    className={`flex flex-col h-full relative rounded-xl overflow-hidden bg-white border border-gray-100 transition-all duration-300 ${
                        isAvailable
