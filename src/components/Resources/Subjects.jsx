...
function Subjects() {
  ...
  if (subjectsError) {
    return <p className="text-center text-red-500">Error: {subjectsError}</p>;
  }
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <h2 className="text-xs sm:text-lg text-center mb-4">
        Semester subjects or Code may vary across different colleges, please
        adjust accordingly
      </h2>
            ...
            <tbody>
              {filteredSubjects[activeSemester].map((subject) => (
                <tr key={subject._id} className="hover:bg-gray-100">
                  ...
                  <td className="border border-gray-300 px-2 text-xs sm:text-lg sm:px-4 py-2">
                    {subject.totalNotes || 0} / {subject.totalPyqs || 0}
                  </td>
