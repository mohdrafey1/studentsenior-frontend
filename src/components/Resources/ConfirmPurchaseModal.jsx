    ...
    <Modal isOpen={isOpen} onClose={onClose} title={title}>
      <div className="space-y-4 p-4 text-center">
        ...
        <p className="text-gray-700">
          ...
          <span className="font-medium">{selectedResource.price}</span> Points =
          <span className="font-medium"> {selectedResource.price / 5}₹</span>
        </p>
        ...
        <div className="flex flex-wrap justify-center items-center gap-3 mt-4">
          ...
          {rewardBalance < selectedResource.price && (
            <p className="text-red-500 w-full">
              ...
              <b>{selectedResource.price - rewardBalance}</b> more points.
            </p>
          )}
