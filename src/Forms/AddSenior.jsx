            ...
            {isSuccess && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                    <div className="bg-white p-6 rounded-xl shadow-2xl max-w-md mx-4 relative overflow-hidden">
                        ...
                        <h2 className="text-xl font-bold text-center text-gray-800">Success</h2>
                        <p className="text-gray-600 mt-2 text-center">{responseMessage}</p>
                    ...
                    <div className="lg:flex">
                        ...
                        <div className="lg:w-1/2 p-8">
                            <div className="text-center mb-6">
                                ...
                                <p className="text-gray-600 mt-2">Share your knowledge and guide junior students</p>
                            ...
                            <form onSubmit={handleAddSenior} className="space-y-4">
                                <div className="grid md:grid-cols-2 gap-4">
                                    {[
                                        { label: 'Name', name: 'name', type: 'text', placeholder: 'Your full name', required: true, className: 'md:col-span-2' },
                                        { label: 'Course/Branch', name: 'branch', type: 'text', placeholder: 'e.g. Computer Science', required: true },
                                        {
                                            label: 'Year', name: 'year', type: 'select', required: true,
                                            options: ['1st Year', '2nd Year', '3rd Year', '4th Year', '5th Year', 'Alumni']
                                        },
                                        { label: 'Expertise', name: 'domain', type: 'text', placeholder: 'Your area of expertise', required: true, className: 'md:col-span-2' },
                                        { label: 'Whatsapp', name: 'whatsapp', type: 'number', placeholder: 'Your WhatsApp number', required: true },
                                        { label: 'Telegram (Optional)', name: 'telegram', type: 'number', placeholder: 'Your Telegram number' },
                                    ].map(({ label, name, type, placeholder, required, className, options }) => (
...
>>>>>>> 81caa9540474d85015bef0d185d0a79b7f7e7782
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="max-w-6xl mx-auto bg-gradient-to-br from-sky-50 to-blue-100 rounded-xl shadow-lg overflow-hidden">
          <div className="lg:flex">
            <div className="lg:w-1/2 p-2 flex items-center">
              <iframe
                className="w-full h-80 lg:h-full rounded-lg"
                src="https://lottie.host/embed/13b6a2bb-8ee5-485e-a88d-ed9c5b3f6977/b9HuPP23fO.json"
                title="Mentor Animation"
            ...
            <div className="lg:w-1/2 p-8">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 mt-2">
                  Share your knowledge and guide junior students
                </p>
                <Seo
