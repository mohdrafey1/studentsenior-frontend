  ...
  return (
    <>
      ...
      <div className="lg:flex bg-gradient-to-t from-sky-200 to bg-white">
        <div className="p-3 max-w-lg lg:mx-auto lg:my-5 lg:bg-white lg:w-2/4 py-10 rounded-xl mx-5 my-10">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-0">
            ...
            <input
              ...
              id="password"
              className="bg-slate-100 p-2 ring-1 px-4 rounded-lg mx-3"
              onChange={handleChange}
            />
            <br />
            <button
        ...
        <div className=" w-2/5 flex content-center">
          <img src={login} alt="illustrature" className="h-2/3 mx-auto my-auto lg:block hidden" />
        </div>
      </div>
    </>
  );
