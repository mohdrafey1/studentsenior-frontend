...
const WhatsAppGroupPage = () => {
    ...
    const filteredGroups = groups.filter((group) => {
        ...
        const matchesDomain =
            domainFilter === '' || group.domain === domainFilter;
            ...
            <div className='max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8'>
                ...
                {loadingGroups ? (
                                ...
                                >
                                    ...
                                    <div className='mt-auto'>
                                        <a
                                            ...
                                            className='w-full flex items-center justify-center px-4 py-3 bg-sky-500 hover:bg-sky-600 text-white font-medium rounded-lg shadow transition-all'
                                        >
                    ...
                    <div className='text-center py-20 bg-white rounded-lg shadow-sm'>
                        ...
                        <Button
                            onClick={openModal}
                            className='px-6 py-3 bg-sky-600 hover:bg-sky-700 text-white font-medium rounded-lg shadow-md'
                        >
                            Add New Group
                        </Button>
                    </div>
