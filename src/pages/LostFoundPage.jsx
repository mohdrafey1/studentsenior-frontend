...
const LostFoundPage = () => {
  ...
  const { lostfound, loading, error } = useSelector((state) => state.lostfound);
      ...
      <div className="max-w-7xl mx-auto p-4 text-center">
        <div>
          ...
          <p className="italic text-center text-xs sm:text-base mb-2">
            Add Found or Lost Item within you college to help each other recover
          </p>
          <Seo
        ...
        <div className="flex justify-center items-center py-8">
          {error && (
            <p className="text-center text-red-500">Error fetching items</p>
          )}
