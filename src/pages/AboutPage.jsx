        ...
        <section className="relative py-20">
          <div className="container mx-auto px-6 text-center">
            ...
            <div className="max-w-4xl mx-auto text-left space-y-6 text-lg text-gray-700">
              <p>
                A one-stop platform for students to select courses, access
                previous year's question papers <strong>(PYQs)</strong>, and
                download <strong>Comprehensive notes</strong>, simplifying{' '}
                <strong>exam</strong> preparation.
              </p>
              <p>
                Connecting students with experienced{' '}
                <strong>Senior Students</strong> for guidance, support, and
                mentorship through <strong>live chats</strong> and{' '}
                <strong>community forums</strong>, ensuring informed decisions
                and academic success.
              </p>
              <p>
                A college-focused <strong>Marketplace</strong> where students
                can select their institution,{' '}
                <strong>
                  buy, and sell used stationery, books, and resources
                </strong>
                , fostering a sustainable and cost-effective community.
              </p>
              <p>
                A course-centric platform connecting students with relevant{' '}
                <strong>internship opportunities</strong>, allowing them to
                select their course and apply for internships, kickstarting
                their professional journey.
              </p>
              <p>
                A college discovery platform where students can select their
                institution and access direct links to{' '}
                <strong>official websites</strong>, admissions, and{' '}
                <strong>essential college resources</strong> effortlessly.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 ">
          <div className="container mx-auto px-6">
            ...
            <p className="text-center max-w-2xl mx-auto mb-12 text-gray-600 text-lg">
              ...
              guidance, resources, and opportunities that help them excel in
