...
const SeniorPage = () => {
  ...
  const courses = [...new Set(filteredSeniors.map((senior) => senior.branch))];
      ...
      <div className="container mx-auto p-5">
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="italic text-center text-xs sm:text-base">
            Reach out to seniors for mentorship and expert guidance on your
            journey
          </p>
          <br />
        ...
        {isEditModalOpen && (
          <EditSeniorModal
            ...
            handleUpdate={async (e) => {
              ...
              try {
                await apiRequest(`${url}/${editingSenior._id}`, 'PUT', payload);
